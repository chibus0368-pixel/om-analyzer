          ...
          <div style={{ padding: "0 20px 20px", borderTop: `1px solid ${C.ghost}` }}>
            ...
            <div style={{ marginTop: 14, display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12 }}>
              <div style={{ fontSize: 11, color: C.secondary, lineHeight: 1.5 }}>
                Baseline is set workspace-wide. Scoring stays comparable across deals as long as every property in a workspace uses the same baseline.
              </div>
              <a href="/workspace/settings" style={{
                display: "inline-flex", alignItems: "center", gap: 5,
                padding: "7px 14px", background: C.surfLow || "#F1F5F9",
                border: `1px solid ${C.ghostBorder || "rgba(0,0,0,0.08)"}`,
                borderRadius: 8, fontSize: 11, fontWeight: 700, color: C.onSurface,
