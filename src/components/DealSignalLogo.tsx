...
export default function DealSignalLogo({
  ...
  // Full logo: bars + dot + curved baseline + "Deal Signals" text
  ...
  return (
    <span style={{ display: "inline-flex", alignItems: "center", textDecoration: "none", ...style }}>
      <svg width={w} height={h} viewBox="0 0 420 120" fill="none" xmlns="http://www.w3.org/2000/svg">
        ...
        {/* Text */}
        <text x="120" y="72" fontFamily="'Plus Jakarta Sans', Inter, Arial, sans-serif" fontSize="38" fontWeight="500" fill={light ? "#ffffff" : "#ffffff"}>
          Deal
        </text>
        <text x="210" y="72" fontFamily="'Plus Jakarta Sans', Inter, Arial, sans-serif" fontSize="38" fontWeight="700" fill="#84CC16">
          Signals
        </text>
      </svg>
    </span>
