        ...
        <div style={{ display: "flex", alignItems: "center", gap: 16 }}>
          {showBranding && (
            <div style={{ display: "flex", alignItems: "center" }}>
              <svg width={126} height={36} viewBox="0 0 420 120" fill="none" xmlns="http://www.w3.org/2000/svg">
                ...
                <text x="120" y="72" fontFamily="Plus Jakarta Sans, Inter, sans-serif" fontSize="38" fontWeight="500" fill="#ffffff">Deal</text>
                <text x="210" y="72" fontFamily="Plus Jakarta Sans, Inter, sans-serif" fontSize="38" fontWeight="700" fill="#84CC16">Signals</text>
              </svg>
            </div>
          )}
