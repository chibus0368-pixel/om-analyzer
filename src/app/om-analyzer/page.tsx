...
.val{font-weight:700;color:#0d0d14}
...
<p style="font-size:15pt;font-weight:700;color:#374151;margin:4px 0 2px 0;">${pName}</p>
<p class="loc">${loc}</p>
...
<p style="font-size:8pt;color:#9CA3AF;margin:8px 0 0 0;">Generated by DealSignals</p>
</div>
</body></html>`;
