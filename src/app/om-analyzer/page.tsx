...
h2{font-size:9.5pt;color:#374151;margin:22px 0 6px 0;padding:0 0 4px 0;border-bottom:1px solid #D1D5DB;font-weight:700;text-transform:uppercase;letter-spacing:0.08em}
...
.note{font-size:8.5pt;color:#9CA3AF;font-style:italic}
...
<h1><span>First-Pass Underwriting Brief</span></h1>
<p class="prop-name">${pName}</p>
<p class="loc">${loc}</p>
${assetType ? `<span class="badge">${assetType}</span>` : ""}
