...
export const metadata: Metadata = {
  title: "Try Pro Free — Deal Signal",
  description: "See what Deal Signal Pro can do. Explore two sample CRE deals with full scoring, analysis, and risk signals — no signup required.",
  openGraph: {
    title: "Try Pro Free — Deal Signal",
