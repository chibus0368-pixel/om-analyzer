  ...
  return (
    <div style={{ maxWidth: 1400, margin: "0 auto", padding: "0 20px" }}>
      ...
      <button
        ...
        style={{ padding: "10px 28px", background: saved ? "#10B981" : rescoring ? "#585e70" : "#65A30D", color: "#fff", border: "none", borderRadius: 8, fontSize: 14, fontWeight: 700, cursor: (rescoring || !hydrated) ? "not-allowed" : "pointer", transition: "background 0.3s" }}
      >
